<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-AgregarStock-{{$materiales->idAgroquimico}}">
          ...
          <div class="block-web">
            ...
            <div class="porlets-content" style="margin-bottom: -50px;">
              ...
              <form action="{{url('almacenes/agroquimicos/stock', [$materiales->idAgroquimico])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate  enctype="multipart/form-data" accept-charset="UTF-8">
                  ...
                  <div class="row">
                    <label class="col-lg-3 control-label">Proveedores : <strog class="theme_color">*</strog></label>
                    <div class="col-lg-8">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <select name="recibio{{$materiales->idAgroquimico}}" value="recibio"   required>  
               ...
               <div class="row">
                ...
                <div class="col-sm-8">
                  <select name="entregado_a{{$materiales->idAgroquimico}}"  value=""   required>  
