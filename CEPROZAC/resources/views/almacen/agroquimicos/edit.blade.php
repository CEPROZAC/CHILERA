...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      ...
      <li><a style="color: #808080" href="{{url('/almacen/materiales')}}">Almacén de Agroquímicos</a></li>
    </ol>
  </div>
</div>
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Editar Agroquímicos: {{ $material->nombre}} </strong></h2> 
            </div>
            <div class="col-md-4">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <select name="medida" value="">
          ...
          <option value="Pastilla">Pastilla</option>
          <option value="Perdigon">Perdigon </option>
          @elseif(($material->medida)=="Pastilla")
          <option value='Toneladas'>Toneladas</option>
          <option value="Litros">Litros</option>
          <option value="Metros" >Metros</option>
