...
<div class="container clear_both padding_fix">
  <div class="row">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input name="cantidad" maxlength="9" type="number" step="any"  max="999999" min="0.1"  value="{{Input::old('cantidad')}}" data-number-to-fixed="2" data-number-stepfactor="100" class="form-control currency" required value="" placeholder="Ingrese la Cantidad en Almacén" onkeypress=" return soloNumeros(event);" />
      </div>    
    </div>  
