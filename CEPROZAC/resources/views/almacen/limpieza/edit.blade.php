...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      <li><a style="color: #808080" href="{{url('/almacen/limpieza')}}">Inicio</a></li>
      <li><a style="color: #808080" href="{{url('/almacen/limpieza')}}">Almacén de Limpieza</a></li>
    </ol>
  </div>
</div>
    ...
    <div class="col-md-12">
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Editar Limpieza: {{ $material->nombre}} </strong></h2> 
            </div>
            <div class="col-md-4">
     ...
     <div class="form-group ">
      ...
      <div class="col-sm-6">
       ...
       @if (($material->imagen)!="")
       <img src="{{asset('imagenes/AlmacenLimpieza/'.$material->imagen)}}" height="100px" width="100px">
       @endif
     </div>
   </div>
