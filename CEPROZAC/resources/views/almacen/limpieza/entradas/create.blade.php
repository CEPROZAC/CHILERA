...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      ...
      <li><a style="color: #808080" href="{{url('/almacenes/limpieza')}}">Entradas de Almacén Materiales de Limpieza</a></li>
    </ol>
  </div>
</div>
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Registrar Entrada de Material de Limpieza</strong></h2>
            </div>
...
<a class="btn btn-sm btn-success tooltips" href="{{ route('almacenes.limpieza.create')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" target="_blank" title="" data-original-title="Registrar nuevo Material"> <i class="fa fa-plus"></i> Registrar Nuevo Material </a>
     ...
     <div class="col-lg-4 col-lg-offset-4">
       <div class="form-group">
        ...
        <div class="col-sm-6">
          <input  id="codigo" value="" name="codigo" type="text" onkeypress="return teclas(event);"  onkeypress=" return soloNumeros(event);"  maxlength="13"  class="form-control"  placeholder="Ingrese el Codigo de Barras"/>
        </div>
      </div>
    </div>
...
@include('almacen.limpieza.entradas.modale')
