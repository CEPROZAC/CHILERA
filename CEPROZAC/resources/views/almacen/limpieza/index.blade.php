          ...
          <div class="header">
            <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
              <div class="col-sm-7">
                ...
                <h2 class="content-header " style="margin-top: -5px;">&nbsp;&nbsp;<strong>Limpieza </strong></h2>
              </div>
              <div class="col-md-12">
                <div class="btn-group pull-right">
                  <b>
                    ...
                    <div class="btn-group" style="margin-right: 10px;">
                      <a class="btn btn-sm btn-success tooltips" href="{{ route('almacenes.limpieza.create')}}" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Registrar nuevo Material"> <i class="fa fa-plus"></i> Registrar Producto Limpieza </a>
