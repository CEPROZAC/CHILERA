        ...
        <div class="porlets-content">
          <form action="{{url('empresas', [$empresas->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-6">
              <input type="text" name="nom_cuenta" class="form-control" required parsley-rangelength="[10,16]" placeholder="Número de cuenta bancaria" maxlength="16" minlength="10"  value="{{$empresas->nom_cuenta}}"/>
            </div>
          </div><!--/form-group--> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text"  name= "cve_Interbancaria" class="form-control" required parsley-rangelength="[18,19]" placeholder="Número de CLABE Interbancaria" maxlength="19" minlength="18" value="{{$empresas->cve_Interbancaria}}"/>
            </div>
          </div><!--/form-group--> 
