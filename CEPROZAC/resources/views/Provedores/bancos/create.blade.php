        ...
        <div class="porlets-content">
          <form action="{{route('bancos.store')}}" method="post" class="form-horizontal row-border" parsley-validate novalidate>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
              <input type="text" parsley-type="phone" placeholder="Ingrese el número de teléfono de el banco" name="telefono" value="" class="form-control mask" data-inputmask="'mask':'(999) 999-9999'">
              </div>
            </div>
