  ...
  <div class="row">
    <div class="col-md-12">
      <div class="block-web">
        ...
        <form action="{{route('fumigaciones.store')}}" method="post" class="form-horizontal row-border" parsley-validate novalidate  files="true" enctype="multipart/form-data" accept-charset="UTF-8">
          {{csrf_field()}}
...
<div class="form-group">
 ...
 <div class="col-sm-6">
  <select name="lote" id="lote"  class="form-control select2" required>
    ...
    <option value="{{$almacen->id_almacen}}_{{$almacen->nombre_lote}}_{{$almacen->id_producto}}">
