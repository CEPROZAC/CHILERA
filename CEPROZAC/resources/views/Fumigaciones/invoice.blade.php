...
<html lang="en">
  ...
  <body>
    ...
    <header class="clearfix">
      ...
      <h1>EN PROCESO DE FUMIGACION  {{$fumigaciones->destino}} </h1>
      <div id="project" >
        <div><span>AGROQUIMICO: {{$fumigaciones->agroquimicos}}</div></span>
        <div><span>CANTIDAD APLICADA:  {{$fumigaciones->cantidad_aplicada}}</div> </span>
        <div><span>FECHA DE INICIO:       {{$fumigaciones->fechai}}</div></span>
