    ...
    <div class="col-md-12">
      <div class="block-web">
        ...
        <div class="porlets-content">
          <form action="{{route('cuentasEmpresasCEPROZAC.store')}}" method="post" class="form-horizontal row-border" parsley-validate novalidate>
            {{csrf_field()}}
        ...
        <div class="form-group ">
          ...
          <div class="col-sm-6">
            <input parsley-type="number" type="text" maxlength="100000000000" required parsley-range="[0, 100000000]" name="saldo"   class="form-control mask"  placeholder="$10343456.00" onkeypress=" return soloNumeros(event);">
          </div>
        </div>
