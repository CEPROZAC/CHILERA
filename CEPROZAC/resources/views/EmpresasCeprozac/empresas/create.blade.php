        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Registrar Empresa CEPROZAC</strong></h2> 
            </div>
            <div class="col-md-4">
        ...
        <div class="porlets-content">
          <form action="{{route('empresasCEPROZAC.store')}}" method="post" class="form-horizontal row-border" parsley-validate novalidate>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="nombre" type="text"  onchange="mayus(this);"  class="form-control" maxlength="100" parsley-rangelength="[1,200]"  required value="" placeholder="Ingrese nombre de la empresa"/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="representanteLegal" type="text"  onchange="mayus(this);"  class="form-control" maxlength="100" parsley-rangelength="[1,200]"  required value="" placeholder="Ingrese Representante legal de la empresa"/>
              </div>
            </div>
            <input name="rfcOculto" id="ocultoRFC"  hidden  />
            <div class="form-group">
              <label class="col-sm-3 control-label">RFC: <strog class="theme_color">*</strog></label>
              <div class="col-sm-6">
                <input name="rfc" type="text" id="rfc"  onchange="mayus(this);validarEmpresaCEPROZAC();"  class="form-control" maxlength="13" id="RFC" type="text" required parsley-regexp="([A-Z,Ñ,&]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1])[A-Z|\d]{3})"   required parsley-rangelength="[12,13]"  onkeyup="mayus(this);"   required value="" placeholder="Ingrese RFC de la empresa"/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input name="direcionFacturacion" type="text"  onchange="mayus(this);"  class="form-control" required value="" placeholder="Ingrese Direccion de la empresa" maxlength="200" parsley-rangelength="[1,200]"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input name="direcionFisica" type="text"  onchange="mayus(this);"  class="form-control" required value="" placeholder="Ingrese Direccion de la empresa" maxlength="200" parsley-rangelength="[1,200]"/>
            </div>
          </div>
