        ...
        <div class="table-responsive">
          <table  class="display table table-bordered table-striped" id="dynamic-table">
            ...
            <tbody>
              ...
              <tr class="gradeA">
                <td>{{$roles->rol_Empleado}} </td>
                <td>{{$roles->descripcion}} </td>
                <td> 
                  <center>
                    <a href="{{URL::action('RolEmpleadoController@edit',$roles->id)}}" class="btn btn-primary btn-sm" role="button"><i class="fa fa-edit"></i></a>  
                  </center>
                </td>

                <td> 
                  <center>
                    <a class="btn btn-danger btn-sm" data-target="#modal-delete-{{$roles->id}}" data-toggle="modal" style="margin-right: 10px;"  role="button"><i class="fa fa-eraser"></i></a>
                  </center>
                </td>
              </td>
            </tr>
