          ...
          <form action="{{route('transportes.store')}}" method="post" class="form-horizontal row-border"  parsley-validate novalidate  >
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <input name="nombre" type="text"  onchange="mayus(this);quitarEspacios(this);"  class="form-control"  required value="" placeholder="Ingrese nombre  de Vehículo" maxlength="35" parsley-rangelength="[1,35]"/>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <textarea name= "descripcion"  onchange="mayus(this);quitarEspacios(this);"  class="form-control" maxlength="300" rows="3" draggable="false" placeholder="Ejemplo: Utilizado como una barredora para piso seco o húmedo de  almacenes..."></textarea>
              </div>
            </div>
