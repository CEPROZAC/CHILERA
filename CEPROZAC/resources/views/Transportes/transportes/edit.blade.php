    ...
    <div class="col-md-12">
      <div class="block-web">
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Editar Vehículo</strong></h2> 
            </div>
            <div class="col-md-4">
        ...
        <div class="porlets-content">
          <form action="{{url('transportes',[$vehiculo->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate>
            {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <input name="aseguradora" type="text"  onchange="mayus(this);"  class="form-control" onkeypress=" return soloLetras(event);" required value="{{$vehiculo->aseguradora}}" placeholder="Aseguradora a la  que esta afiliada Vehículo" maxlength="35" parsley-rangelength="[1,35]"/>
