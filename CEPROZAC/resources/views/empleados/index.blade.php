              ...
              <div class="btn-group pull-right">
                <b>
                  ...
                  <div class="btn-group" style="margin-right: 10px;">
                    <a class="btn btn-sm btn-success tooltips" href="clientes/create" style="margin-right: 10px;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Registrar nuevo Empleado"> <i class="fa fa-plus"></i> Registrar </a>
               ...
               <td><center><b>Borrar</b></center></td>
                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">
                      ...
                      <td>  <a href="{{URL::action('ClienteController@edit',1)}}" class="btn btn-primary btn-sm" role="button"><i class="fa fa-edit"></i></a> 
                  </td>
