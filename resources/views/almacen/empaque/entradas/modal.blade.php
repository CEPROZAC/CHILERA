  ...
  <div class="modal-dialog">
        ...
        <div class="row">
          <div class="block-web">
            ...
            <div class="porlets-content" style="margin-bottom: -50px;">
              <h4>¿Esta segúro que desea eliminar este Registro de Entrada de Almacén de Agroquímicos?</h4>
            </div><!--/porlets-content--> 
          </div><!--/block-web--> 
        </div>
      </section>
    ...
    <div class="modal-footer" style="margin-top: -10px;">
      <div class="row col-md-5 col-md-offset-7" style="margin-top: -5px;">
        <form action="{{url('almacen/salidas/empaque', [$entradas->id])}}" method="POST"> 
