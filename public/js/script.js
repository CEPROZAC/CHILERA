...
function doSearch()
{
  ...
  var compareWith="";
    ...
    function  validarProvedor(){
     ...
     var route = "http://localhost/CHILERA/CEPROZAC/public/validarProvedor/"+nombre;
...
function  validarEmpresa(){
 ...
 var route = "http://localhost/CHILERA/CEPROZAC/public/validarEmpresa/"+rfc;
 ...
 $.get(route,function(res){
  ...
  document.getElementById('submit').disabled=false;
   ...
   function  validarBanco(){
     ...
     var route = "http://localhost/CHILERA/CEPROZAC/public/validarBanco/"+nombre;
...
function  validarPlacas(){
  ...
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarPlacas/"+placa;
...
function  validarNumeroSerie(){
  ...
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarPlacas/"+serie;
...
function  validarEmpresaCEPROZAC(){
  ...
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarEmpresasCEPROZAC/"+rfc;
...
function  validarNumeroCuentaEmProvedor(){
  ...
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarNumCuenta_Cve_Interbancaria/"+num_cuenta;
...
function  validarNumeroCveInterbancariaEmProvedor(){
  ...
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarNumCuenta_Cve_Interbancaria/"+cve_Interbancaria;
...
function  validarNumeroCuentaEmCEPROZAC(){
  ...
  var num_cuenta =document.getElementById('num_cuenta').value;
  var ocultoNumCuenta =document.getElementById('ocultoNumCuenta').value;
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarNumCuenta_Cve_InterbancariaCEPROZAC/"+num_cuenta;
  console.log(route);
...
function  validarNumeroCveInterbancariaEmCEPROZAC(){
  ...
  var cve_Interbancaria =document.getElementById('cve_Interbancaria').value;
  var ocultoCve_Interbancaria =document.getElementById('ocultoCve_Interbancaria').value;
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarNumCuenta_Cve_InterbancariaCEPROZAC/"+cve_Interbancaria;
...
function  validarCURP(){
  ...
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarCURP/"+curp;
...
function  validarSSN(){
  ...
  var route = "http://localhost/CHILERA/CEPROZAC/public/validarCURP/"+numero_Seguro_Social;
